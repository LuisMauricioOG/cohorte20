...
INSERT INTO productos (nombre, precio, fecha_alta, idCategoria, existencia, marca) VALUES ('Ariel blancos', 50, curdate(), 27, 69, 'Ariel');
...
INSERT INTO categoria VALUES ('Antojitos');
INSERT INTO categoria (nombre) VALUES ('d');

update productos SET marca = 'Bimbo' WHERE idProducto = 22;
update productos SET marca = 'Motita' WHERE idProducto = 26;
update productos SET marca = 'Rocaleta' WHERE idProducto = 25;
update productos SET marca = 'KK' WHERE idProducto = 24;
